...
/**
 * The UnmanagedLauncher is a simple client that launches an unmanaged AM. An
...
public class UnmanagedAMLauncher {
	...
	private static final Logger log = Logger.getLogger(UnmanagedAMLauncher.class);
	...
	private ApplicationReport monitorApplication(ApplicationId appId, Set<YarnApplicationState> finalState) 
		...
		while (true) {
			...
			// wait for 10 seconds after process has completed for app report to come back
			if (amCompleted) {
